          ...
          <div className="text-center max-w-sm">
            ...
            <div className="bg-blue-50 rounded-lg p-4 border border-blue-200 mb-4">
              ...
              <p className="text-sm text-blue-700 mb-3">
                ...
                <span className="font-semibold">light</span> to see how it
                works!
              </p>
              <Link
                to="/u/$username/chat"
                params={{ username: 'light' }}
                className="inline-flex items-center justify-center rounded-lg text-sm font-medium h-9 px-4 bg-blue-600 text-white hover:bg-blue-700 transition-colors shadow-sm"
              >
                Message light
              </Link>
            </div>
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
              ...
              <p className="text-sm text-gray-600">
                Type any username in the search box to start a new chat!
              </p>
            </div>
          </div>
        </div>
